...
import { LayoutDashboard, Glasses, FolderHeart, ShoppingBag, Eye, LogOut, ShieldAlert, ArrowLeft, Menu, X, CreditCard, Sliders } from 'lucide-react';
...
export default function AdminLayout({ children }) {
  ...
  const menuItems = [
    ...
    { name: 'Manage Sliders', href: '/admin/sliders', icon: <Sliders size={18} /> },
